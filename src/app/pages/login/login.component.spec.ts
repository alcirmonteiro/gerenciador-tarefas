...
describe('LoginComponent', () => {
  ...
  it('deve fazer a autenticação do usuário', () => {
    ...
    (loginFacadeService.login as jest.Mock).mockReturnValue(of({ token: 'fake-jwt-token' }));

    testHelper.submitForm('login-form');

    expect(loginFacadeService.login).toHaveBeenCalledWith(fakeEmail, fakePassword);
